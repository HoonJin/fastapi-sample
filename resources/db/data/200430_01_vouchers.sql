INSERT INTO `vouchers` (`name`, `par_value`, `category`, `created_at`, `updated_at`) VALUES
 ...
 ('롯데호텔(종이식) 10만원권', 100000.00, '호텔/외식', NOW(), NOW()),
 ...
 ('삼성상품권(종이식) 10만원권', 100000.00, '백화점', NOW(), NOW()),
 ...
 ('각종 기프트 카드 30만원권', 300000.00, '기프트', NOW(), NOW()),
 ('각종 기프트 카드 10만원권', 100000.00, '기프트', NOW(), NOW()),
 ('각종 기프트 카드 5만원권', 50000.00, '기프트', NOW(), NOW()),
 ('농협 기프트 카드 50만원권', 500000.00, '기프트', NOW(), NOW()),
 ('농협 기프트 카드 30만원권', 300000.00, '기프트', NOW(), NOW()),
 ('농협 기프트 카드 10만원권', 100000.00, '기프트', NOW(), NOW()),
 ('농산물(농협)상품권 10만원권', 100000.00, '할인마트', NOW(), NOW()),
 ('농산물(농협)상품권 1만원권', 10000.00, '할인마트', NOW(), NOW()),
